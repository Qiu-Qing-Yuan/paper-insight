...
const navItems = [
  ...
  { icon: 'overview', label: '数据总览', path: '/overview' },
...
<template>
  <aside class="sidebar" :class="{ expanded }">
      ...
      <div class="nav-group">
        ...
        >
          <div class="item-icon-wrap">
            ...
            <svg v-else-if="item.icon === 'overview'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- User Menu: inside sidebar when expanded -->
    <Transition name="menu-pop">
      <div v-if="userMenuOpen && expanded" class="user-menu">
